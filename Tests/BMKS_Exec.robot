...
Resource  ../Keywords/Common_BMKSExec.robot
...
${WrittenComents3}  Response1 Response1 Response1 Response1 Response1 Response1 Response1 Response1 Response1
${WrittenComents4}  Response2 Response2 Response2 Response2 Response2 Response2 Response2 Response2 Response2
...
07_Start Survey and Submit
  ...
  Wait Until Element Is Visible  xpath=(//*[starts-with(@id,'mat-input-')])[3]  timeout=40
  Input Text  xpath=(//*[starts-with(@id,'mat-input-')])[3]  ${WrittenComents3}
  Wait Until Element Is Visible  xpath=(//*[starts-with(@id,'mat-input-')])[4]  timeout=40
  Input Text  xpath=(//*[starts-with(@id,'mat-input-')])[4]  ${WrittenComents4}
