...
Resource  ../Keywords/Common_LM_FR.robot
...
07_Start Survey and Submit
  Wait Until Element Is Visible  xpath=(//span[contains(text(),'Auto-évaluation')])[11]  timeout=30
  Click Element  xpath=(//span[contains(text(),'Auto-évaluation')])[11]
  Sleep  3 seconds
  ...
  #SubmitSurvey
  #Wait Until Element Is Visible  xpath=//span[contains(text(),'ENVOYER LE QUESTIONNAIRE')]  timeout=40
  #Click Element  xpath=//span[contains(text(),'ENVOYER LE QUESTIONNAIRE')]
  #Sleep  5 seconds
  #Save Selenium Screenshot
