...
07_Start Self Survey
  Wait Until Element Is Visible  xpath=(//span[contains(text(),'Selbst')])[5]   timeout=60
  Sleep  3 seconds
  Click Element  xpath=(//span[contains(text(),'Selbst')])[5]
