...
Resource  ../Keywords/Common_LM_ES.robot
...
${email}  spanishpart@testmail.com
#${password}  I@s12345
${password}   Pass11dev
${Delay}  30
...
07_Start Survey and Submit
  ...
  Save Selenium Screenshot
  Information Section
  Wait Until Element Is Visible  xpath=//span[contains(text(),'Grupo siguiente')]  timeout=40
  Click Element  xpath=//span[contains(text(),'Grupo siguiente')]
  ...
  SubmitSurvey
  Wait Until Element Is Visible  xpath=//span[contains(text(),'ENVIAR EL CUESTIONARIO')]  timeout=40
  Click Element  xpath=//span[contains(text(),'ENVIAR EL CUESTIONARIO')]
  Sleep  5 seconds
  Save Selenium Screenshot
