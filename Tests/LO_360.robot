...
Resource  ../Keywords/Common_LO.robot
...
07_Start Survey and Submit
  Wait Until Element Is Visible  xpath=(//span[contains(text(),'Self')])[7]  timeout=30
  Click Element  xpath=(//span[contains(text(),'Self')])[7]
  Sleep  3 seconds
