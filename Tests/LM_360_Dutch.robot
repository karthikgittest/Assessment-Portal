...
Resource  ../Keywords/Common_LM_Dut.robot
...
07_Start Survey and Submit
  Wait Until Element Is Visible  xpath=(//span[contains(text(),'Zelf')])[3]  timeout=30
  Click Element  xpath=(//span[contains(text(),'Zelf')])[3]
  Sleep  3 seconds
  ...
  Sleep  3 seconds
  Save Selenium Screenshot
  Wait Until Element Is Visible  xpath=//*[@class='mat-raised-button mat-primary']//span[contains(text(),'Nee')]  timeout=40
  Click Element  xpath=//*[@class='mat-raised-button mat-primary']//span[contains(text(),'Nee')]
  Wait Until Element Is Visible  xpath=(//span[contains(text(),'Enquête starten')])[2]  timeout=40
  Sleep  3 seconds
  Save Selenium Screenshot
  Click Element  xpath=(//span[contains(text(),'Enquête starten')])[2]

  Test data for Survey1
  Save Selenium Screenshot
  Information Section
  Wait Until Element Is Visible  xpath=//span[contains(text(),'Volgende groep')]  timeout=40
  Click Element  xpath=//span[contains(text(),'Volgende groep')]
  ...
  Test data for Survey1
  Save Selenium Screenshot
  Wait Until Element Is Visible  xpath=//span[contains(text(),'Volgende')]  timeout=40
  Click Element  xpath=//span[contains(text(),'Volgende')]
  ...
  #Review
  Wait Until Element Is Visible  xpath=//span[contains(text(),'Samenvatting')]  timeout=40
  Save Selenium Screenshot
  Sleep  3 seconds
  Click Element  xpath=//span[contains(text(),'Samenvatting')]
  
  #YourResponses
  Wait Until Element Is Visible  xpath=//span[contains(text(),'Uw antwoorden')]  timeout=40
  Save Selenium Screenshot
  Information Section

  #SubmitSurvey
  #Wait Until Element Is Visible  xpath=//span[contains(text(),'ENQUÊTE INDIENEN')]  timeout=40
  #Click Element  xpath=//span[contains(text(),'ENQUÊTE INDIENEN')]
  #Sleep  5 seconds
  #Save Selenium Screenshot
