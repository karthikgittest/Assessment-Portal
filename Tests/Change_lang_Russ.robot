...
*** Variables ***
${email}  russianpart@testmail.com
${password}  Pass11dev
${Delay}  30
...
07_Start Self Survey
  Wait Until Element Is Visible  xpath=(//span[contains(text(),'Самооценка')])[3]   timeout=60
  Sleep  3 seconds
  Click Element  xpath=(//span[contains(text(),'Самооценка')])[3]
